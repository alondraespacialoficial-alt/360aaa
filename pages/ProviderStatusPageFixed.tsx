/**
 * Página de Estado del Proveedor - Versión con formulario de búsqueda
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        {/* Formulario de búsqueda - Solo mostrar si no hay registro */}
        {!registration && (
        ...
        {/* Contenido principal - Solo mostrar si hay registro */}
        {registration && (() => {
